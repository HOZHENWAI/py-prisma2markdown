...
CARDINALITY_DICT = {
    "LEFT" : {"ZERO_OR_ONE" : RelationTypeLeft.ZERO_OR_ONE,
              "EXACTLY_ONE" : RelationTypeLeft.EXACTLY_ONE,
              "MANY" : RelationTypeLeft.MANY
              },
    "RIGHT" : {"ZERO_OR_ONE" : RelationTypeRight.ZERO_OR_ONE,
...
class Relation:
    ...
    def to_mermaid(self):
        mermaid_output = f"{self.left} {self.cardinality_left}{self.existence}" \
